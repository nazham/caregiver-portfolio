...
export const portfolioContent: PortfolioContent = {
  ...
  about: {
    title: "About Me",
    bioParagraphs: [
      "My name is <strong class=\"text-accent font-semibold\">Mohamed Rifai Mohamed Isham</strong>, and I am a dedicated caregiver with a strong passion for providing compassionate, respectful, and professional care. I successfully completed a <strong class=\"text-primary-text font-bold\">Diploma in Caregiving</strong> from Medicina Alternativa, affiliated with the <em class=\"text-primary-text font-medium\">Open International University for Complementary Medicines</em> and <em class=\"text-primary-text font-medium\">Azteca University</em>.",
      "I believe that quality caregiving is built on <strong class=\"text-primary-text font-semibold\">kindness, patience, trust, and dignity</strong>. My goal is to create a safe, supportive, and comfortable environment for every client while assisting with their daily needs and overall well-being. I am committed to treating each person with compassion, respect, and genuine care, <strong class=\"text-accent font-semibold\">just like family</strong>.",
      "With my caregiver training and practical knowledge, I support <strong class=\"text-primary-text font-semibold\">elderly individuals</strong>, <strong class=\"text-primary-text font-semibold\">patients recovering at home</strong>, and those who require personal assistance and companionship. I always strive to provide dependable, attentive care that improves quality of life."
    ],
    values: [
      {
