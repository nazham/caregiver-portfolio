  ...
  return (
    <footer className="bg-[#FAF6F0] py-10 md:py-4 border-t border-[#0F172A]/5">
      <div className="container-custom flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8">
        ...
        {/* Copyright */}
        <p className="text-xs md:text-sm text-[#0F172A]/40 text-center md:text-left leading-relaxed max-w-[280px] sm:max-w-none">
          © {new Date().getFullYear()} {personalInfo.name}. All rights reserved.
        </p>
        
        {/* Regional Badges */}
        <div className="flex items-center justify-center gap-4 text-xs font-medium text-[#0F172A]/40 uppercase tracking-wider">
