...
export default function Error({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="min-h-screen bg-primary-bg flex flex-col justify-center items-center px-4 py-8 text-center transition-colors duration-300">
      <div className="max-w-md w-full bg-secondary-bg border border-primary-border p-8 rounded-2xl shadow-sm">
        ...
        <button
          onClick={() => reset()}
          className="btn-primary w-full py-3.5 px-6 rounded-lg font-semibold flex items-center justify-center gap-2 cursor-pointer"
        >
